...
export class Four1681472547604 implements MigrationInterface {
    name = 'Four1681472547604'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_032f36b55436efe49e6775b4898\` ON \`chapter\``);
        ...
        await queryRunner.query(`ALTER TABLE \`chapter\` CHANGE \`storyId\` \`storyId\` int NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`replay\` ADD CONSTRAINT \`FK_23ce68b0d78d7fb8dbb263166c3\` FOREIGN KEY (\`sentenceId\`) REFERENCES \`sentence\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`CREATE INDEX \`FK_032f36b55436efe49e6775b4898\` ON \`chapter\` (\`storyId\`)`);
    }
