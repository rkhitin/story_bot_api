...
export class Init1682151299575 implements MigrationInterface {
    name = 'Init1682151299575'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`reply\` (\`id\` int NOT NULL AUTO_INCREMENT, \`isActive\` tinyint NOT NULL DEFAULT 1, \`text\` varchar(255) NOT NULL, \`hint\` varchar(255) NOT NULL, \`sentenceId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`answer\` (\`id\` int NOT NULL AUTO_INCREMENT, \`tUserId\` int NOT NULL, \`replyId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
